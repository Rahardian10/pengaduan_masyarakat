            ...
            <form action="/masyarakat/ajukan" method="post" enctype="multipart/form-data" role="form">
              ...
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" name="tgl_pengaduan" class="form-control" id="name" placeholder="Tgl Pengaduan" data-rule="minlen:4" data-msg="Please enter at least 4 chars" value="{{ date('d-m-Y') }}" readonly/>
                  <div class="validate"></div>
                </div>
                <div class="col-md-6 form-group">
                  <input type="text" class="form-control" name="nik" id="nik" placeholder="NIK Anda" data-rule="nik" data-msg="Please enter NIK" value="{{auth()->user()->nik}}" readonly/>
                  <div class="validate"></div>
                </div>
              </div>
