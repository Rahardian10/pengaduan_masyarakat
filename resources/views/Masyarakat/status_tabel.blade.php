                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$sts->masyarakat->nama}}</td>
                        <td>{{$sts->judul}}</td>
                        <td>{{$sts->tgl_pengaduan}}</td>
                        <td>
                            <img src="{{asset('image/'. $sts->foto)}}" height="100px" alt="">
                        </td>
                        
                            @if($sts->level == '0')
                                <td><span class="btn btn-warning btn-sm">Belum Diproses</span></td>
                            @elseif($sts->level == 'proses')
                        ...
                        <td>
                            <a href="/masyarakat/detail-pengaduan/{{$sts->id_pengaduan}}" class="btn btn-primary btn-sm"><i class="bx bx-plus"></i></a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
