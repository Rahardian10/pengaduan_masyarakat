...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <a href="/admin/pengaduan" class="btn btn-secondary btn-sm">Kembali</a>
                <hr>
                <form action="/admin/proses/tanggapi" method="post" class="" novalidate>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="/admin/tanggapi" method="post" id="search_form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('templates.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduan_masyarakat\resources\views/Admin/petugas/detail-pengaduan.blade.php ENDPATH**/ ?>