      ...
      <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="/admin/detai/pengaduan/<?php echo e($adm->id_pengaduan); ?>" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-zoom-in"></i></a>
            </td>
          </tr>
...
<?php echo $__env->make('templates.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduan_masyarakat\resources\views/Admin/petugas/pengaduan.blade.php ENDPATH**/ ?>