...
<html lang="en">
  ...
  <body>
    ...
    <table class="table" align="center" border="1px" style="width: 95%;">
        ...
        <tbody>
        <?php $__currentLoopData = $cetak_tanggal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
          <tr>
...
</html><?php /**PATH C:\xampp\htdocs\pengaduan_masyarakat\resources\views/Laporan/cetak_tanggal.blade.php ENDPATH**/ ?>